      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-28 pb-20 sm:pt-36 sm:pb-28">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              href="https://wa.me/0000000000?text=Hi%20StrucAxis%2C%20I'd%20like%20to%20discuss%20an%20in-house%20fit-out."
              target="_blank"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 sm:py-20">
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              <h2 className="text-3xl sm:text-4xl font-semibold">Everything under one roof</h2>
              <p className="mt-4 text-gray-600">
                Our production clusters reduce dependency on third parties and keep quality and timelines firmly
                under control. That’s how we finish fast-track projects without compromising finish.
              </p>
              <ul className="mt-6 space-y-3 text-gray-800">
                <LI icon={<FaHammer />} text="Carpentry & premium joinery (CNC enabled)" />
                <LI icon={<FaCouch />} text="Custom furniture & finishes (PU, veneer, laminates)" />
                <LI icon={<FaWarehouse />} text="Glass processing & UPVC windows/doors" />
                <LI icon={<MdOutlinePrecisionManufacturing />} text="Metal fabrication & powder coating" />
                <LI icon={<FaTools />} text="On-site assembly labs & mock-up bays" />
                <LI icon={<FaShieldAlt />} text="HSE compliance with QA/QC at each stage" />
              </ul>
            </div>

            <div className="grid grid-cols-2 gap-4">
              {[
                "https://images.unsplash.com/photo-1519710164239-da123dc03ef4e?q=80&w=1200&auto=format&fit=crop",
                ...
                <div key={i} className="aspect-[4/3] overflow-hidden rounded-xl">
                  <img src={src} alt="" className="h-full w-full object-cover hover:scale-105 transition" />
                </div>
              ))}
            </div>
          </div>
